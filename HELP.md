...
* The original package name 'it.gov.pagopa.idpay-lolab-payment' is invalid and this project uses 'it.gov.pagopa.idpaylolabpayment' instead.
...
```
$ docker run --rm -p 8080:8080 idpay-lolab-payment:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/idpay-lolab-payment
```
